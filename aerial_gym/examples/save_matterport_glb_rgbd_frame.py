...
if __name__ == "__main__":
    ...
    if rgb_tensor.sum().item() <= 0.0:
        raise RuntimeError("RGB tensor is empty after sensor capture.")
    ...
    rgb_path = os.path.join(out_dir, "matterport_glb_rgb_frame.png")
    depth_path = os.path.join(out_dir, "matterport_glb_depth_frame.png")
